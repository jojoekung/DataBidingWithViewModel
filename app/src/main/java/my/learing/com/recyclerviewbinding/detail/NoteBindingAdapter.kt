...
@BindingAdapter(value = ["app:onDeleteNote"])
fun deleteNote(button: Button, noteDetailViewModel: NoteDetailViewModel) {
    button.setOnClickListener {
        noteDetailViewModel.onDeleteNote(noteDetailViewModel.getNoteId())
    }
}
